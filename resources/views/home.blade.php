...
<!-- ==========================================
     ...
     ========================================== -->
<section id="hero" class="relative min-h-[calc(100vh-4rem)] sm:min-h-[calc(100vh-5rem)] flex items-center overflow-hidden py-6 sm:py-12 px-4 sm:px-6 lg:px-12 bg-black">
    <!-- Hero Background Image - Centered CUE CORNER Illuminated Wall Sign & Ceiling Light Box -->
    <div class="absolute inset-0 pointer-events-none z-0">
        <img src="{{ asset('Asset/Image/background/Background cuecorner.png') }}" alt="Cue Corner Lounge" class="w-full h-full object-cover object-[25%_25%] sm:object-[25%_center] opacity-90">
        <!-- Subtle Gradient Overlays for High Contrast & Visual Depth -->
        <div class="absolute inset-0 bg-gradient-to-b sm:bg-gradient-to-l from-black/85 via-black/50 to-black/20 sm:to-transparent"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto w-full">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
            ...
            <!-- Right Side: Sleek Black Glass Card (Balanced Mobile Positioning) -->
            <div class="mt-20 sm:mt-28 lg:mt-0 lg:col-span-6 xl:col-span-6 text-left bg-black/80 sm:bg-black/85 backdrop-blur-xl sm:backdrop-blur-2xl p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-white/15 shadow-2xl shadow-black">
